<aside class="left-side sidebar-canvas bg-light">
    <section id="sidebar mt-3">
        <ul class="sidebar-menu">
            ...
            <li class="link-item"><a href="/emas_project/users.php"><i class="bi bi-person-fill-gear"></i> View Users</a></li>
            <li class="link-item"><a href="/emas_project/add_user.php"><i class="bi bi-key-fill"></i> Permit User</a></li>
            <li class="link-item"><a href="/emas_project/attendance.php"><i class="bi bi-calendar-range"></i> Attendance</a></li>
            <li class="link-item"><a href="/emas_project/logout.php"><i class="bi bi-box-arrow-right"></i> Logout</a></li>
        </ul>
    </section>
</aside>
